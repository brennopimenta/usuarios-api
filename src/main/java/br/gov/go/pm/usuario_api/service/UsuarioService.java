...
import br.gov.go.pm.usuario_api.model.UsuarioModel;
import br.gov.go.pm.usuario_api.model.UsuarioSecurityModel;
import br.gov.go.pm.usuario_api.repository.GrupoRepository;
import br.gov.go.pm.usuario_api.repository.PermissaoRepository;
import br.gov.go.pm.usuario_api.repository.UsuarioRepository;
...
//        UsuarioEntity usuarioEntity = this.usuarioRepository.findOne(codigoUsuario);
        UsuarioEntity usuarioEntity = this.usuarioRepository.findById(codigoUsuario).get();
...
//        UsuarioEntity usuarioEntity =  this.usuarioRepository.findOne(usuarioModel.getCodigo());
        UsuarioEntity usuarioEntity =  this.usuarioRepository.findById(usuarioModel.getCodigo()).get();
        ...
        for (Long codigoGrupo : usuarioModel.getGrupos()){
            ...
            if(codigoGrupo != null){
				...
				/*CONSULTA GRUPO POR CÓDIGO*/
//                grupoEntity = grupoRepository.findOne(codigoGrupo);
                grupoEntity = grupoRepository.findById(codigoGrupo).get();
